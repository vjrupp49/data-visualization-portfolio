---
title: "Interactive SNAP Participation Gap Map"
author: "Vincent Rupp"
date: 2026-04-26
format: html
---
...
This is an interactive map of SNAP/MFIP participation gaps across census tracts in Hennepin County. The goal is to identify areas where residents are eligible for benefits but are not enrolled, and to highlight patterns that are hidden when only looking at city-level averages.

## What This Visualization Shows

-   Each census tract is colored based on its **gap rate**, defined as:\
    (Eligible − Enrolled) / Eligible

-   Higher values indicate a larger share of eligible residents who are not enrolled

-   The map shows us:

    -   data across all years or by individual year

    -   the top 5%, 10%, 15%, and 20% tracts with highest difference between it's own gape rate, and it's cities gap rate

    -   tracts and their detailed enrollment and eligibility information

This helps reveal “hidden” high-gap areas that are not visible in city-level summaries.
